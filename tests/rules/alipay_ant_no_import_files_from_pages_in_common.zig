...
test "reports @alipay/ant/no-import-files-from-pages-in-common in src common files" {
    const source =
        \\import pageA from 'appfw/page-home';
        \\import pageB from '@scope/appfw-mobile/page-detail';
        \\import ok from 'appfw/component-card';
    ;
    ...
    try std.testing.expectEqualStrings(
        "don't import things from src/pages/ while you're in src/common: reading `appfw/page-home` now.",
...
test "allows @alipay/ant/no-import-files-from-pages-in-common outside src common" {
    const source = "import pageA from 'appfw/page-home';\n";
