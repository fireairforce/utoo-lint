...
pub fn lintSource(
    ...
    const needs_semantic = options.parser_semantic_errors or options.no_alert or options.no_global_is_finite or options.no_global_is_nan or options.no_new_wrappers or options.no_unused_vars or options.no_undef;
